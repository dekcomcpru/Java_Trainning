 ...
 *
 */
 public class WebTierLog4jInit extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public WebTierLog4jInit() {
		super();
	}   	
	...
	public void init() throws ServletException {
		...
		File f = new File(System.getProperty("user.home") + File.separator
				+ getInitParameter("WebTierLog4jInitPropsFile"));
		if (!f.canRead()) {
			throw new ServletException("Init WebTier log4j Exception");
		}
		
		System.out.println("Init WebTier log4j path --> " + f.toString());
		...
		String log4jProp = f.toString() + File.separator + "WebTierLog4j.properties";
		System.out.println("Init WebTier log4j file --> " + log4jProp);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("reload".equals(mode)){
	        ...
	        init();
	        System.out.println("Init WebTierLog4jInit Reload");
